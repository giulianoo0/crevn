...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openExternal: (url: unknown) => ipcRenderer.invoke('app:openExternal', url),
  ...
  listReferenceFolders: () => ipcRenderer.invoke('generation:listReferenceFolders'),
  ...
  regenerateDirectorMessage: (payload: unknown) => ipcRenderer.invoke('generation:regenerateDirectorMessage', payload),
  ...
  createReferenceFolder: (payload: unknown) => ipcRenderer.invoke('generation:createReferenceFolder', payload),
  setCharacterVoiceUrl: (payload: unknown) => ipcRenderer.invoke('generation:setCharacterVoiceUrl', payload),
  ...
  pasteClipboardImageToSceneFrame: (sceneFrameId: string) =>
