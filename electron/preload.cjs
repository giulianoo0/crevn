...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  regenerateDirectorMessage: (payload) => ipcRenderer.invoke('generation:regenerateDirectorMessage', payload),
  ...
  createReferenceFolder: (payload) => ipcRenderer.invoke('generation:createReferenceFolder', payload),
  setCharacterVoiceUrl: (payload) => ipcRenderer.invoke('generation:setCharacterVoiceUrl', payload),
